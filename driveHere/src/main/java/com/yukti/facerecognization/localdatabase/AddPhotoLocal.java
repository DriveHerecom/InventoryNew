...
import com.yukti.facerecognization.CameraSurfacePreview;

public class AddPhotoLocal extends ActionBarActivity implements Camera.PreviewCallback {
...
//	private ImageView galleryButton;   // ImageView to access the device gallery
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_add_photo_local);
		vibrate = (Vibrator) AddPhotoLocal.this
		...
		animationFadeOut = AnimationUtils.loadAnimation(AddPhotoLocal.this,
...
//		galleryButton = (ImageView) findViewById(R.carId.gallery_button);
	...
	private void startCamera() {
		...
		mPreview = new CameraSurfacePreview(AddPhotoLocal.this, cameraObj,
				orientationListener); //Create a new surface on which Camera
										// will be displayed.
		preview = (FrameLayout) findViewById(R.id.cameraPreview);
		preview.addView(mPreview);
		cameraObj.setPreviewCallback(AddPhotoLocal.this);
	}
...
//		}
	...
	private void usePicture(byte[] data) {
		Intent intent = new Intent(this, ImageConfirmationLocal.class);
		if (data != null)
		{
			intent.putExtra(
		...
		intent.putExtra(
				"com.creadigol.mekanikal.ImageConfirmation.switchCamera",
				cameraFacingFront);
		intent.putExtra(
				"com.creadigol.mekanikal.ImageConfirmation.orientation",
				displayAngle);
