...
public class ImageConfirmation extends BaseActivity {
...
//									"No face found", Toast.LENGTH_SHORT).show();
	...
	private boolean createAlert() {
		...
		builder.setMessage("Are you sure you want to add this person");
	...
	public void saveAlbum() {
		...
		Log.e("albumBuffer", Arrays.toString(albumBuffer) +"");
		...
		face = Arrays.toString(albumBuffer);
		userid = AppSingleTon.SHARED_PREFERENCE.getUserId();
		Log.e("userid", userid);
		//Toast.makeText(ImageConfirmation.this, "face = "+ Arrays.toString(albumBuffer) +"," +"Userid = "+ AppSingleTon.SHARED_PREFERENCE.getUserId(), Toast.LENGTH_LONG).show();
		addFace();
	...
	void addFace() {
		...
		JsonHttpResponseHandler handler = new JsonHttpResponseHandler() {
			...
			public void onFailure(int statusCode, Header[] headers,
				...
				Log.d("Add Face error response", responseString);
				showToast("Add Face Error");
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				Log.d("ADD_FACE_response", response.toString());
				...
				if (orm.status_code.equals("1")) {
					...
					Toast.makeText(getApplication(),"face uploaded succesfully", Toast.LENGTH_SHORT).show();
//					setResult(Activity.RESULT_OK);
//					finish();
					
					AppSingleTon.SHARED_PREFERENCE.setUserFace(face);
...
//						finish();
//					}else{
//						Intent intent = new Intent(ImageConfirmation.this,com.yukti.drivehere.MainActivity.class);
...
//					}
				...
				//	finish();
					...
					//Log.e("msg",orm.msg);
					//Toast.makeText(getApplication(), orm.msg, Toast.LENGTH_SHORT).show();
					//Toast.makeText(ImageConfirmation.this, "asdsdf", Toast.LENGTH_LONG).show();
				}
			...
			public void onStart() {
				super.onStart();
				showUpdateProgressDialog("face is uploading...");
			}
		...
		String url = AppSingleTon.APP_URL.URL_FACE;
		RequestParams params = new RequestParams();
		params.put("carId", userid);
