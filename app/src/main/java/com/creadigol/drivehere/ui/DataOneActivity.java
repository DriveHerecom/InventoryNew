...
import com.creadigol.drivehere.dataone.model.CommonUsData;
import com.creadigol.drivehere.dataone.model.DecoderMessages;
import com.creadigol.drivehere.dataone.model.Efficiency;
import com.creadigol.drivehere.dataone.model.Engine;
import com.creadigol.drivehere.dataone.model.Installed_Equipment;
import com.creadigol.drivehere.dataone.model.OptionalEquipment;
import com.creadigol.drivehere.dataone.model.OptionsC;
import com.creadigol.drivehere.dataone.model.OtherInfo;
import com.creadigol.drivehere.dataone.model.Pricing;
import com.creadigol.drivehere.dataone.model.Query_Error;
import com.creadigol.drivehere.dataone.model.RequestSample;
import com.creadigol.drivehere.dataone.model.SafetyEquipment;
import com.creadigol.drivehere.dataone.model.Specifications;
import com.creadigol.drivehere.dataone.model.Transmission;
import com.creadigol.drivehere.dataone.model.US_Styles;
import com.creadigol.drivehere.dataone.model.UsMarketData;
import com.creadigol.drivehere.dataone.model.Warranties;
...
public class DataOneActivity extends AppCompatActivity {
    ...
    private final String TAG = DataOneActivity.class.getSimpleName();
    public static final String EXTRA_KEY_VIN = "Vin";
    public static final String EXTRA_KEY_CAR_ID = "car_id";

    private String vin;
    private String carId;

    private LinearLayout ll_EXColors, ll_ITColors, ll_RFColors, ll_Engines, ll_Efficiency, ll_BasicData, ll_Specification, ll_OtherInfo,
    ...
    private TextView tv_ExColor, tv_ItColor, tv_RfColor, tv_fleet, tv_market, tv_complete, tv_name, tv_ExColorCommonUs,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vin = bundle.getString(EXTRA_KEY_VIN, "");
        carId = bundle.getString(EXTRA_KEY_CAR_ID, "");

        if (vin.length() == 17 && vin != null) {
            reqDateOneInfo();
        } else {
            CommonFunctions.showToast(DataOneActivity.this, "Incorrect vin");
        }
    ...
    public void reqDateOneInfo() {
        ...
        String url = AppUrl.URL_DATA_ONE_INFO;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (basicResponse.getStatusCode() == 1) {
                        CommonFunctions.showToast(DataOneActivity.this, basicResponse.getMessage());

                        JSONObject res = null;
                        try {
                            res = new JSONObject(CommonFunctions.base64Decode(basicResponse.getDataOneInfo()));
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        DataOneResponse dataOneResponse = DataOneResponse.parseJSON(res.toString());
                        setData(dataOneResponse);
                        ...
                        CommonFunctions.showToast(DataOneActivity.this, response);
                    }

                } catch (Exception e) {
                    CommonFunctions.showToast(DataOneActivity.this, getString(R.string.network_error));
                    e.printStackTrace();
    ...
    void setData(DataOneResponse orm) {
    ...
    void AddViewInBasicData(BasicData basicData, boolean is_from_usdata) {
        ...
        if (basicData.getModel() != null && basicData.getModel().length() != 0) {
            ((TextView) basicDataView.findViewById(R.id.edt_model)).setText(basicData.getModel());
        } else {
            ((TextView) basicDataView.findViewById(R.id.edt_model)).setText(Constant.KEY_NOT_AVAILABLE);
        }
        ...
        if (basicData.getYear() != null && basicData.getYear().length() != 0) {
            ((TextView) basicDataView.findViewById(R.id.edt_year)).setText(basicData.getYear());
        } else {
            ((TextView) basicDataView.findViewById(R.id.edt_year)).setText(Constant.KEY_NOT_AVAILABLE);
        }
