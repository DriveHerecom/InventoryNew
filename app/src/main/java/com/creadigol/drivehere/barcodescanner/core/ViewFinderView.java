package com.creadigol.drivehere.barcodescanner.core;
...
public class ViewFinderView extends View {
    ...
    private static final float LANDSCAPE_WIDTH_RATIO = 5f/6;
    private static final float LANDSCAPE_HEIGHT_RATIO = 5f/8;
    private static  int LANDSCAPE_MAX_FRAME_WIDTH = (int) (1920 * LANDSCAPE_WIDTH_RATIO); // = 5/8 * 1920
    private static  int LANDSCAPE_MAX_FRAME_HEIGHT = (int) (1080 * LANDSCAPE_HEIGHT_RATIO); // = 5/8 * 1080
    ...
    void resetLandscape(){
		...
		LANDSCAPE_MAX_FRAME_WIDTH = (int) (width * LANDSCAPE_WIDTH_RATIO); // = 5/8 * 1920
	    LANDSCAPE_MAX_FRAME_HEIGHT = (int) (height * LANDSCAPE_HEIGHT_RATIO); // = 5/8 * 1080
